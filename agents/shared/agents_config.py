...
# Agent Server Ports
CUSTOMER_DATA_AGENT_PORT = int(os.getenv("CUSTOMER_DATA_AGENT_PORT", "10020"))
SUPPORT_AGENT_PORT = int(os.getenv("SUPPORT_AGENT_PORT", "10021"))
HOST_AGENT_PORT = int(os.getenv("HOST_AGENT_PORT", "10022"))

# Agent Server URLs
CUSTOMER_DATA_AGENT_URL = os.getenv(
    "CUSTOMER_DATA_AGENT_URL", f"http://localhost:{CUSTOMER_DATA_AGENT_PORT}"
)
SUPPORT_AGENT_URL = os.getenv(
    "SUPPORT_AGENT_URL", f"http://localhost:{SUPPORT_AGENT_PORT}"
)
HOST_AGENT_URL = os.getenv("HOST_AGENT_URL", f"http://localhost:{HOST_AGENT_PORT}")
